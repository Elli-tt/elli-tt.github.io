...
We are El Plugins ('Company', 'we', 'us', or 'our').
...
We provide a service where users purchase our plugins and use them on an online game. The service includes a launcher as well as plugins.
...
These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ('you'), and El Plugins, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
Subject to your compliance with these Legal Terms, including the 'PROHIBITED ACTIVITIES' section below, we grant you a non-exclusive, non-transferable, revocable licence to:
    ...
    download a copy of any portion of the Content to which you have properly gained access.
...
o   Cards: Visa, Mastercard, American Express, Discover, Diners Club and China UnionPay payments from customers worldwide.

o   Wallets: Apple Pay, Google Pay, Link

o   Bank Redirects: Bancontact, EPS, giropay, iDeal, przelewy24, Sofort

o   Buy now, pay later: Afterpay/Clearpay, Klarna

o   Bank Debits: Bacs Direct Debit, SEPA Direct Debit

·         In Game Currency

o   Oldschool Runescape Gold Pieces
...
You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in US dollars, alternatively in game currency specified within the discord server.
...
As a user of the Services, you agree not to:
    ...
    Sharing Keys with other members
    Charging back without speaking to customer services
    Personal advertising within the platform
    Subscriptions cannot be swapped for other packages, or transferred to another discord. Errors can be corrected within 24 hours of purchase.
    Do not be in affiliation with any cracking, or hacking discords, websites, groups, etc. Being so gives us the right to remove you from our service.
    We can revoke access at any time, at our discretion. This includes, but is not limited to; Sharing keys/plugins, Leaking Videos/Pictures
    Usage of the plugins is at your own risk; we make no guarantee of any detectability status.
    If you get banned from the game, or removed from our service, you are not entitled to a refund.
